<template>
    <div class="interaction-post">
        <ul class="interaction-post__list">
            ...
            <li class="interaction-post__list-item">
                <button type="button" class="interaction-post__btn" @click="modify" v-if="isOwner">
                ...
                <button type="button" class="interaction-post__btn" @click="reply" v-else-if="!isOnRecursifPost">
                    <svg width="20" height="20" viewBox="0 0 24 24">
                        <path
